...
class TestInMemoryInvertedIndexWithoutCompression(unittest.TestCase):
    ...
    def test_access_postings(self):
        ...
        corpus.add_document(in3120.InMemoryDocument(
            1, {"body": "test TEST prØve"}))
        index = in3120.InMemoryInvertedIndex(
            corpus, ["body"], self._normalizer, self._tokenizer, self._compressed)
    ...
    def test_multiple_fields(self):
        ...
        index = in3120.InMemoryInvertedIndex(
            corpus, ['felt1', 'felt3'], self._normalizer, self._tokenizer, self._compressed)
